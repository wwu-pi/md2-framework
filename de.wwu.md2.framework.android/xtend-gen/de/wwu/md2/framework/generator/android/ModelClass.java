...
public class ModelClass {
  protected static CharSequence _createClass(final /* Entity */Object entity, final String basePackage) {
  ...
  public static CharSequence createClass(final Enum md2Enum, final String basePackage) {
    if (md2Enum != null) {
      return _createClass(md2Enum, basePackage);
    } else if (md2Enum != null) {
      return _createClass(md2Enum, basePackage);
    } else {
      throw new IllegalArgumentException("Unhandled parameter types: " +
        Arrays.<Object>asList(md2Enum, basePackage).toString());
    }
  }
}
