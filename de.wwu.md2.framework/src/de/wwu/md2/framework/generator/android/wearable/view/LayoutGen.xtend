...
//					fsa.generateFile(rootFolder + Settings.DRAWABLE_PATH, generateDrawableIcons(mainPackage))
	...
	def static generateMaterialIcons(IExtendedFileSystemAccess fsa, String rootFolder) {
		fsa.generateFile(rootFolder + Settings.DRAWABLE_PATH + "ic_add_shopping_cart_black_24dp.xml",
		...
		fsa.generateFile(rootFolder + Settings.DRAWABLE_PATH + "ic_shopping_cart_black_24dp.xml",
			"<vector xmlns:android=\"http://schemas.android.com/apk/res/android\"
        android:width=\"24dp\"
        android:height=\"24dp\"
        android:viewportWidth=\"24.0\"
		...
		fsa.generateFile(rootFolder + Settings.DRAWABLE_PATH + "ic_remove_shopping_cart_black_24dp.xml",
			"<vector xmlns:android=\"http://schemas.android.com/apk/res/android\"
        android:width=\"24dp\"
        android:height=\"24dp\"
        android:viewportWidth=\"24.0\"
