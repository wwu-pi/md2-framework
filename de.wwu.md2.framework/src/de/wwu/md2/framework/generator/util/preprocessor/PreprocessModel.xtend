...
class PreprocessModel {
	...
	def static ResourceSet preprocessModel(MD2Factory factory, ResourceSet input) {
		...
		setFlowLayoutPaneDefaultParameters(factory, workingInput)
		
		duplicateSpacers(factory, workingInput)
		
		replaceNamedColorsWithHexColors(factory, workingInput)
		
		mergeNestedWorkflows(factory, workingInput)
		
		createAutoGenerationAction(factory, workingInput)
		
		replaceCombinedActionWithCustomAction(factory, workingInput)
