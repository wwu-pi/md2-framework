...
class ProcessAutoGenerator {
	 ...
	 * for mappings and validators. Furthermore, a <i>__startupAction</i> is created and registered in the main block for the
	 * onInitialized event. The <i>__startupAction</i> first calls this autoGenerationAction and then the actual startup action
	 * that was originally declared for the onInitialized event.
	 * 
	 * <p>
	 *   DEPENDENCIES: None
	 * </p>
	...
	def static void createAutoGenerationAction(MD2Factory factory, ResourceSet workingInput, Iterable<AutoGeneratedContentElement> autoGenerators) {
		...
		if (getAutoGenAction(workingInput) == null) {
			...
			if (ctrl != null) {
				...
				// create __startupAction and register in main block
				...
				// register __startupAction as onInitializedEvent
				...
				startupAction.codeFragments.add(autoGenCallTask);
