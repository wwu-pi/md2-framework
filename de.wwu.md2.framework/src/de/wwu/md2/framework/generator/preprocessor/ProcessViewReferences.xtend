...
class ProcessViewReferences {
	 ...
	 */
	def static cloneContainerElementReferencesIntoParentContainer(
	 ...
	 */
	def static cloneViewElementReferencesIntoParentContainer(
	 ...
	 */
	def static replaceStyleRefernces(MD2Factory factory, ResourceSet workingInput) {
	 ...
	 * </ul>
	 */
	def static copyAllCustomCodeFragmentsToClonedGUIElements(
		MD2Factory factory, ResourceSet workingInput, HashMap<ViewElementType, ViewElementType> clonedElements,
		HashMap<CustomCodeFragment, ViewElementType> clonedCodeFragments
	) {
		
		val Iterable<CustomCodeFragment> codeFragments = workingInput.resources.map[r |
			r.allContents.toIterable.filter(typeof(CustomCodeFragment))
		].flatten.toList
	 ...
	 * </ul>
	 */
	def static removeAllCustomCodeFragmentsThatReferenceUnusedGUIElements(
		MD2Factory factory, ResourceSet workingInput, HashMap<CustomCodeFragment, ViewElementType> clonedCodeFragments
	) {
		val gotoViewActions = workingInput.resources.map[ r |
			r.allContents.toIterable.filter(typeof(GotoViewAction))
		].flatten
	 ...
	 */
	def static simplifyReferencesToAbstractViewGUIElements(MD2Factory factory, ResourceSet workingInput, HashMap<ViewElementType, ViewElementType> clonedElements) {
	 ...
	 */
	def private static addToParentCodeContainer(CustomCodeFragment codeFragment, EObject container) {
